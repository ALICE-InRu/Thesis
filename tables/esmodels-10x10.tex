\begin{table}[]\centering
    ...
    %jsp
    \subcaptionbox{$\mathcal{P}_{ j.rnd }^{10\times10}$\label{tbl:test:j.rnd}}
    {
    ...
    \quad
    \subcaptionbox{$\mathcal{P}_{ j.rndn }^{10\times10}$\label{tbl:test:j.rndn}}
    {
        \begin{tabular}{lrrrrr}
            \toprule
            model& mean & med & sd & min & max \\ 
    ...
    %flow shop
    \quad
    \subcaptionbox{$\mathcal{P}_{ f.rnd }^{10\times10}$\label{tbl:test:f.rnd}}
    {
        \begin{tabular}{lrrrrr} \toprule
            ...
            \bottomrule \end{tabular}}
    \quad
    \subcaptionbox{$\mathcal{P}_{ f.rndn }^{10\times10}$\label{tbl:test:f.rndn}}
    {
        \begin{tabular}{lrrrrr} \toprule
            model&mean & med & sd & min & max \\   \midrule
            ...
            \bottomrule \end{tabular}}
    \quad
    \subcaptionbox{$\mathcal{P}_{ f.jc }^{10\times10}$\label{tbl:test:f.jc}}
    {
        \begin{tabular}{lrrrrr} \toprule
            model&mean & med & sd & min & max \\   \midrule
