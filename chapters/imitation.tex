...
\section{Prediction with Expert Advice}\label{sec:expertPolicy}
...
\section{Follow the Perturbed Leader}\label{sec:perturbedLeader}
...
new strategy, where we follow the \emph{Perturbed Leader} ($\OPT\epsilon$). 
...
\caption{Box-plots for \namerho, following either expert policy or perturbed 
leader for \Problem[6\times5]{\train} and \jrnd{10}{10}}
\end{figure}
