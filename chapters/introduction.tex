...
s, with the aid of Genetic Programming (GP), is promising. However, there is 
large number of rules to choose from, thus their combinations require expert 
...
for Case Based Reasoning (CBR), which were hard do understand and cumbersome in 
