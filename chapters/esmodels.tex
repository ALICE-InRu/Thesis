...
\chapter{Evolutionary learning of CDRs}\label{ch:esmodels} \todo[color=green!40,noline]{\cref{ch:ES} Unfinished, taken from GECCO submission}
...
%jsp
\subfloat[][\jrnd{10}{10}]{\label{tbl:test:j.rnd}
\begin{tabular}{lrrrrr}  \toprule
...
\bottomrule \end{tabular}}
\\
\subfloat[][\jrndn{10}{10}]{\label{tbl:test:j.rndn}
\begin{tabular}{lrrrrr} \toprule
model& mean & med & sd & min & max \\ 
  \midrule
...
%flow shop
\\
\subfloat[][\frnd{10}{10}]{\label{tbl:test:f.rnd}
\begin{tabular}{lrrrrr} \toprule
model&mean & med & sd & min & max \\   \midrule
...
\bottomrule \end{tabular}}
\\
\subfloat[][\frndn{10}{10}]{\label{tbl:test:f.rndn}
\begin{tabular}{lrrrrr} \toprule
model&mean & med & sd & min & max \\   \midrule
...
\bottomrule \end{tabular}}
\\
\subfloat[][\fjc{10}{10}]{\label{tbl:test:f.jc}
\begin{tabular}{lrrrrr} \toprule
model&mean & med & sd & min & max \\   \midrule
