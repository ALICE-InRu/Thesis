...
\begin{figure} 
	\subcaptionbox{minimise w.r.t. 
	\cref{eq:cma:makespan}}{\includegraphics[width=\textwidth]{{CMAweightsEvo.ES_Cmax}.eps}\label{fig:cma:wei:cmax}}
	\\
	\subcaptionbox{minimise w.r.t. 
	\cref{eq:cma:rho}}{\includegraphics[width=\textwidth]{{CMAweightsEvo.ES_rho}.eps}\label{fig:cma:wei:rho}}
