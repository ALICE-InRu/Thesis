...
\end{inparaenum}
\tcr{For local level construction a simple construction heuristic is applied, 
...
\begin{figure*} 
	\subcaptionbox{minimise w.r.t. \cref{eq:cma:makespan}}{\includegraphics[width=\columnwidth]{CMAweightsEvomin_Cmax}\label{fig:cma:wei:cmax}}
	\\
	\subcaptionbox{minimise w.r.t. \cref{eq:cma:rho}}{\includegraphics[width=\columnwidth]{CMAweightsEvomin_rho}\label{fig:cma:wei:rho}}
