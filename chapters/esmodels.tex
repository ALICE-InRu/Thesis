...
the time independent models (for all training data) on the benchmark problem 
...
\begin{figure} 
\subcaptionbox{evolution of weights for time independent models
     \label{fig:cma:wei:1}}{
\includegraphics[width=\textwidth]{{CMAES.weights.timeindependent}.pdf}}\\
\subcaptionbox{stepwise evolultion of final weights for time dependent models
    \label{fig:cma:wei:K}}{
