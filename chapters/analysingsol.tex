...
In the case of \jrnd{10}{10} then +\phijobOps yields mean $\rho=22\%$, whereas 
it's more sophisticated counterpart, +\phijobWrm\ has a slightly higher mean 
$\rho=23$ (cf. \cref{tbl:CDR:pareto}).
