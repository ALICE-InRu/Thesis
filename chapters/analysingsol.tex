...
\begin{figure}
    \subcaption{Without Bonferroni adjustment\label{tbl:jrnd:feat:corr:SDR}}{
            \includegraphics[width=\textwidth]{{j.rnd/phi.corr.SDR.6x5}.pdf}}
    \subcaption{With Bonferroni adjustment\label{tbl:jrnd:feat:corr:ALL}}{
    ...
    \namerho]{Stepwise significant correlation (denoted by $\cdot$) for 
        ...
        across the tables are denoted by $\bullet$.}\label{tbl:jrnd:feat:corr}
\end{figure}
