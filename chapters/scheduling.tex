...
For instance, the \textit{travelling salesman problem}\footnote{
    ...
    The salesman has to visit a set of cities exactly once (i.e. Hamilton 
...
comprehend it via disjunctive graph to model the work-flow of tasks to be 
scheduled.
...
to \phiSDRRelated\ (but for one roll-out per fixed SDR). 
