...
This was done for all \Problem[10\times10]{\text{train}} in \cref{tbl:data}, 
each consisting of $N_{\text{train}}=300$ problem instances.
...
Current literature still hold \sdr s in high regard, as they are simple to 
...
as the full feature set was clearly suboptimal w.r.t. its CMA-ES benchmark from 
\cref{ch:esmodels}. 
...
$\Delta\rho\approx6\%$ (using $\Psi_p^{\minCmax}$) and now 
$\Delta\rho\approx2\%$ (using CDR 3.524) in favour of evolutionary search (cf. 
