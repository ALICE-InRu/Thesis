...
\cref{eq:jsp:linweights} corresponding applying a single priority dispatching 
rules from \cref{sec:SDR}. For instance, 
...
However one can easily see that this sequence of task assignments is by no means unique. 
