...
%chquotes from \emph{Alice's Adventures in Wonderland} \citeyearpar{alice} by 
%Lewis \citeauthor{alice}.

\chquote{Alice}{What is the use of a book, without pictures or conversations?} 
\chquote{Rabbit}{Oh my ears and whiskers, how late it's getting!}
...
not myself you see.}
\chquote[\cref{InRu15b}]{The Duchess}{If everybody minded their own business, 
...
\chquote{The Cat}{We're all mad here.}
...
\chquote[\cref{InRu15a}]{The Mock Turtle}{Reeling and Writhing, of course, to 
begin 
with, and then the different branches of arithmetic -- Ambition, Distraction, 
Uglification, and Derision.}
\chquote{The Mock Turtle}{Well, I never heard it before, but it sounds uncommon 
nonsense.}
...
\chquote[\cref{InRu15c}]{Alice}{But then, shall I never get any older than I am 
...
\chquote{Alice}{I think I should understand that better, if I had it written 
down: but I can't quite follow it as you say it.}
\chquote{The Duchess}{That's nothing to what I could say if I chose. }
\chquote{The Queen}{Now, I give you fair warning, either you or your head must 
...
that rate!}
\chquote[\cref{ch:prefmodels}]{Alice}{It was much pleasanter at home, when 
...
\chquote{Alice}{It was much pleasanter at home, when one wasn't always growing 
larger and smaller, and being ordered about by mice and rabbits.}
\chquote[\cref{ch:experiments}]{The Gryphon}{The adventures first... 
explanations take such a dreadful time.}
\chquote{Narrator}{Either the well was very deep, or she fell very slowly, for 
she had plenty of time as she went down to look about her and to wonder what 
...
\chquote{The Queen}{Now, here, you see, it takes all the running you can do, to 
...
question.}
\chquote{The Queen}{Sometimes I've believed as many as six impossible things 
before breakfast. }
\chquote{The Queen}{Always speak the truth, think before you speak, and write 
it down afterwards.}
