...
\nomenclature[x01]{$\Psi_b$}{preference set added w.r.t. basic ranking}
\nomenclature[x02]{$\Psi_f$}{preference set added w.r.t. full subsequent 
ranking}
\nomenclature[x03]{$\Psi_p$}{preference set added w.r.t. partial subsequent 
ranking}
\nomenclature[x04]{$\Psi_a$}{union of all aforementioned rankings, i.e., 
...
\nomenclature[x12]{$\Phi^{ALL}$}{union of all aforementioned trajectories, 
i.e.,  $\Phi^{ALL}=\Phi^{SPT}\cup \Phi^{LPT}\cup \Phi^{LWR}\cup \Phi^{MWR} \cup 
\Phi^{OPT} \cup \Phi^{RND} \cup \Phi^{CMA}$}
