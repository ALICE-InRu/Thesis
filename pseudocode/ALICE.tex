\begin{algorithm}[t]
    \caption[Overview of \fullnameAlice\ framework]{\fullnameAlice\ (\Alice) 
    framework, given a problem space $\mathcal{P}$, an expert policy 
    $\pi_\star$, and set of benchmark algorithms $\mathcal{A}$.} 
    \label{pseudo:alice}
    \begin{algorithmic}[1]
