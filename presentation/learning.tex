\section{Preference Learning}\againframe<13|handout:0>{alice}
\frame{\frametitle{Ordinal Regression}\framesubtitle{}
    ...
    $$ h(\vphi) = \inner{\alert<2>{\vec{w}}}{\vphi} $$
...
\frame{\frametitle{Passive Imitation Learning}\framesubtitle{}
...
\frame{\frametitle{Active Imitation Learning}\framesubtitle{}
