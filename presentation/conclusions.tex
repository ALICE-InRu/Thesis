...
\frame{\frametitle{Using \Alice\ Framework I}\framesubtitle{}
The thesis introduces a framework for learning (\alert<1>{linear}) \cdr\ -- 
...
\frame{\frametitle{Using \Alice\ Framework II}\framesubtitle{}
...
\pause 
    ...
    \PsiSet[\DA{i}]{p}.
\pause
    \item Instead of reusing the same problem instances, extend the training 
    set with \alert<4>{new} instances for \alert<4>{quicker convergence} of 
    DAgger.
\pause 
